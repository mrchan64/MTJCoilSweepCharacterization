...
function WFGSin(WFG, channel, freq, offset, amplitude, phase);
% WFGSin(WFG, channel, freq);
% WFGSin(WFG, channel, freq, offset);
% WFGSin(WFG, channel, freq, offset, amplitude);

% Creates a sine wave on the Keysight 33600A.
...
% set waveform
fprintf(WFG, 'SOUR%d:FUNC sin', channel);
